            ...
            {done ? (
              ...
              <form onSubmit={submit}>
                <div className="mb-5">
                  ...
                  <h2 className="mt-2 font-display text-2xl italic text-text">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <label className="block">
                    ...
                    <input value={form.whatsapp} inputMode="tel" onChange={(e) => set("whatsapp", e.target.value)} className={inputCls} />
                  </label>
                  <label className="block">
                    <span className="mb-1 block text-xs text-muted">E-mail</span>
                    <input value={form.email} inputMode="email" type="email" onChange={(e) => set("email", e.target.value)} className={inputCls} />
                  </label>
                  <label className="block">
                    <span className="mb-1 block text-xs text-muted">Cidade / Estado</span>
                    <input value={form.cidade_estado} onChange={(e) => set("cidade_estado", e.target.value)} className={inputCls} />
                  </label>
                  <label className="block sm:col-span-2">
                    <span className="mb-1 block text-xs text-muted">Tipo de projeto</span>
                    <select value={form.tipo_projeto} onChange={(e) => set("tipo_projeto", e.target.value)} className={inputCls}>
                      {TIPOS.map((t) => (
